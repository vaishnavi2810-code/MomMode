...
class TestCancelAppointment:
    ...
    def test_cancel_appointment_success(self, db_session: Session, sample_user_with_oauth, sample_appointment):
...
class TestGetUpcomingAppointments:
    ...
    def test_get_upcoming_appointments(self, db_session: Session, sample_user_with_oauth, sample_appointment):
        ...
        # Should have at least the sample appointment
